package com.indiainsure.android.MB360.insurance.repository.selectedPolicyRepo.responseclass;

import com.google.gson.annotations.Expose;
import com.google.gson.annotations.SerializedName;
import com.indiainsure.android.MB360.insurance.repository.responseclass.GroupGMCPoliciesDatum;
import com.indiainsure.android.MB360.insurance.repository.responseclass.GroupGPAPoliciesDatum;
import com.indiainsure.android.MB360.insurance.repository.responseclass.GroupGTLPoliciesDatum;


public class GroupPolicyData {
    /**
     * this class consists the model of all the group policies
     * (same as {@link GroupGMCPoliciesDatum } ,{@link GroupGPAPoliciesDatum },{@link GroupGTLPoliciesDatum } )
     * all the three model class has same data just class names are different
     * this for the interoperability of the code so that it can be differentiated
